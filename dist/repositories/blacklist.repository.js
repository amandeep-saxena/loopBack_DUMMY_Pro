...
let BlacklistRepository = class BlacklistRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource) {
        super(models_1.Blacklist, dataSource);
    }
};
exports.BlacklistRepository = BlacklistRepository;
exports.BlacklistRepository = BlacklistRepository = tslib_1.__decorate([
